...
//		s1.display("=");
		...
		do {
			...
			System.out.println("7. Students scoring more than 90 marks: ");
			System.out.println("8. Students names scoring more than 90 marks: ");
			...
			case 8 :
				...
				List<String> studentNameabove90 = students.stream()
														  .filter(stu->stu.getMarks()>90)
														  .map(st->st.getName())
														  .toList();
														  
				System.out.println(studentNameabove90);
